const releaseItConfig = {
	...
	hooks: {
		...
		"after:@release-it/conventional-changelog:init":
			"echo 'after:@release-it/conventional-changelog:init' && echo 'version: ${version}'",
		...
		"after:git:init": "echo 'after:git:init' && echo 'version: ${version}'",
		"after:git:release":
		...
		"after:version:init": "echo 'after:version:init' && echo 'version: ${version}'",
		...
		"before:@release-it/conventional-changelog:init":
			"echo 'before:@release-it/conventional-changelog:init' && echo 'version: ${version}'",
		...
		"before:git:init": "echo 'before:git:init' && echo 'version: ${version}'",
		"before:git:release":
		...
		"before:github:init": "echo 'before:github:init' && echo 'version: ${version}'",
		"before:github:release":
			"echo 'before:github:release' && echo 'version: ${version}, latestVersion: ${latestVersion}, name: ${name}, branchName: ${branchName}'",
		"before:init": "echo 'before:init' && echo 'version: ${version}'",
		"before:release":
		...
		"before:version:init": "echo 'before:version:init' && echo 'version: ${version}'",
